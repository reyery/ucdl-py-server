...
RASTER_DEM= os.path.join(os.path.dirname(__file__), "FAD_res200_with_wind_frequency.tif")
...
def run_urban_wind_upload(session, data_tif, sim_bound):
    # env.overwriteOutput = True
